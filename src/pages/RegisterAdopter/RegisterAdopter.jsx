...
const RegisterAdopter = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 p-4">
      <h1 className="text-3xl font-bold mb-6">Adoptante - Información personal</h1>
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md space-y-4">
        ...
        <h2 className="text-lg font-semibold mt-4">¿Tienes animales en casa?</h2>
        ...
        <button
          className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 rounded-lg transition duration-200 w-full"
        >
          Aceptar
        </button>
      </div>
